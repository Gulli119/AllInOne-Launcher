(function () {
  ...
  T.en['dl.r.wv.min'] = 'Required (auto on Win10, preinstalled on Win11)';
  T.it['dl.r.wv.min'] = 'Richiesto (auto su Win10, preinstallato Win11)';
  T.en['dl.r.cpu.min'] = 'Dual-core x64';
  T.it['dl.r.cpu.min'] = 'Dual-core x64';
  T.en['dl.r.cpu.rec'] = 'Quad-core+ (4K streaming + game in background)';
  T.it['dl.r.cpu.rec'] = 'Quad-core+ (streaming 4K + gioco in background)';
  T.en['dl.r.gpu.min'] = 'Integrated, with HW video accel.';
  T.it['dl.r.gpu.min'] = 'Integrata con accel. HW video';
  T.en['dl.r.gpu.rec'] = 'Dedicated (smooth 4K browser decode)';
  T.it['dl.r.gpu.rec'] = 'Dedicata (decode 4K browser fluido)';
  T.en['dl.r.disk'] = 'Disk';
  T.it['dl.r.disk'] = 'Disco';
  T.en['dl.r.disk.min'] = '~150 MB (app + sidecar)';
  T.it['dl.r.disk.min'] = '~150 MB (app + sidecar)';
  T.en['dl.r.ctrl.min'] = 'XInput (Xbox/compatible) for full UX';
  T.it['dl.r.ctrl.min'] = 'XInput (Xbox/compatibile) per UX completa';
  T.en['dl.r.ctrl.rec'] = 'Xbox wireless/wired';
  T.it['dl.r.ctrl.rec'] = 'Xbox wireless/cablato';
  T.en['dl.r.net'] = 'Network';
  T.it['dl.r.net'] = 'Rete';
  T.en['dl.r.net.min'] = 'Only if you use streaming/cover art';
  T.it['dl.r.net.min'] = 'Solo se usi streaming/cover art';
  T.en['dl.r.net.rec'] = 'Bandwidth for 1080p/4K';
  T.it['dl.r.net.rec'] = 'Banda per 1080p/4K';
  T.en['dl.honest.t'] = 'Honest about the numbers';
  T.it['dl.honest.t'] = 'Onestà sui numeri';
  T.en['dl.honest.d'] = '<p><strong>Launcher alone:</strong> ~150–250 MB RAM, negligible CPU at idle. Minimal footprint — that\'s the point.</p><p><strong>Streaming:</strong> opens YOUR default browser → requirements = the browser\'s, for 1080p/4K video. Old PC + 4K Netflix = stutter, browser\'s fault not the launcher\'s.</p><p><strong>Games/emulators:</strong> launched as separate processes → requirements set by the game/emu; the launcher adds no significant overhead while they run.</p><p><strong>Node sidecar:</strong> starts only when needed, auto-exits after 60s idle.</p><p><strong>No dedicated GPU</strong> needed for the launcher itself — the UI is simple web. It\'s for what you launch.</p><p class="text-on-surface"><strong>Bottom line:</strong> any PC that can run your games/streaming runs the launcher fine. It\'s not the bottleneck. Practical minimum: a working Windows 10 PC + a controller. Alpha = untested on exotic/ARM hardware.</p>';
  T.it['dl.honest.d'] = '<p><strong>Launcher da solo:</strong> ~150–250 MB RAM, CPU trascurabile a riposo. Footprint minimo, è il punto di forza.</p><p><strong>Streaming:</strong> apre il TUO browser default → requisiti = quelli del browser per video 1080p/4K. Vecchio PC + 4K Netflix = scatti, colpa del browser non del launcher.</p><p><strong>Giochi/emulatori:</strong> lanciati come processi separati → requisiti dettati dal gioco/emu, il launcher non aggiunge overhead mentre girano.</p><p><strong>Sidecar Node:</strong> parte solo quando serve, auto-exit dopo 60s idle.</p><p><strong>No GPU dedicata</strong> necessaria per il launcher in sé — la UI è web semplice. Serve per ciò che lanci.</p><p class="text-on-surface"><strong>Sintesi:</strong> qualsiasi PC capace di far girare i tuoi giochi/streaming fa girare il launcher senza problemi. Non è lui il collo di bottiglia. Minimo pratico: PC Windows 10 funzionante + un controller. Alpha = non testato su hardware esotico/ARM.</p>';
  T.en['dl.req.os'] = 'OS';
  T.it['dl.req.os'] = 'OS';
  T.en['dl.req.cpu'] = 'CPU';
  T.it['dl.req.cpu'] = 'CPU';
